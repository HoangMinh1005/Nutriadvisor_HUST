...
print(f"\nĐang tìm kiếm thực đơn tối ưu sử dụng thuật toán CSP Constraint Backtracking (DB Mode)...")
...
if result["feasible"]:
    ...
    print("\n======================================================================")
    print("CHI TIẾT THỰC ĐƠN 7 NGÀY (2200 kcal - 200k VND/ngày - Dị ứng hải sản) - DB MODE")
    print("======================================================================")
    ...
    print("\n[LỖI] Không thể tìm thấy thực đơn khả thi.")
