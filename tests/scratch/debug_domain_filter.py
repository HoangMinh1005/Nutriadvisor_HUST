...
print("Filtered Breakfast domain:", [scheduler.food_by_id[fid]["name_vi"] for fid in breakfast_foods])
print("Filtered Lunch domain:", [scheduler.food_by_id[fid]["name_vi"] for fid in lunch_foods])
...
print("Total valid scaled daily plans found:", len(valid_scored))
